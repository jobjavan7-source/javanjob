 ...
 *
 * قبلاً این فایل از GapGPT استفاده می‌کرد؛ طبق تصمیم صریح مدیر سایت، تولید
 * مقاله دیگر هیچ ارتباطی با GapGPT ندارد. نام فایل/کلاس عمداً تغییر نکرده
 * (فقط برای این‌که generator.php و images.php نیازی به ویرایش نداشته
 * باشند).
 */
class JJAA_GapGPT {
